...
def _setup_plotly_template_foo():
    ...
    pio.templates["foo"] = go.layout.Template(
        layout=dict(
            ...
            colorway=["#10798E", "#C1DEC1", "#E18B1A", "#EA00E3", "#E7DA59", "#F1A8BD", "#6A7C59",
                      "#8C0993", "#C1E0A4", "#8383FD", "#5DC885", "#FE39FB", "#66E0DD", "#9A54AD",
                      "#2FDF3E", "#A945C9", "#85903F", "#530B0B", "#9A54AD", "#4FE77A", "#D40000"],
            hovermode="x unified",
        ),
        data=dict(
            bar=[
